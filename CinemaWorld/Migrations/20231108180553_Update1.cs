        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PageContent = table.Column<string>(type: "nvarchar(max)", maxLength: 15000, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CinemaWorldUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_News_AspNetUser_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_News_AspNetUsers_CinemaWorldUserId",
                        column: x => x.CinemaWorldUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CinemaCategory = table.Column<int>(type: "int", nullable: false),
                    TrailerPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CoverPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    WallpaperPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Imdblink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewAuthors", x => new { x.ReviewId, x.AuthorId });
                    table.ForeignKey(
                        name: "FK_ReviewAuthors_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReviewAuthors_Reviews_ReviewId",
                        column: x => x.ReviewId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsComments_AspNetUser_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_NewsComments_AspNetUsers_CinemaWorldUserId",
                        column: x => x.CinemaWorldUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieComments_AspNetUser_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MovieComments_AspNetUsers_CinemaWorldUserId",
                        column: x => x.CinemaWorldUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MovieProjections_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MovieProjections_Halls_HallId",
                        column: x => x.HallId,
                        principalTable: "Halls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NextVoteDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StarRatings_AspNetUser_AspNetUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleTransactions_AspNetUser_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SaleTransactions_AspNetUsers_CinemaWorldUserId",
                        column: x => x.CinemaWorldUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SaleTransactions_MovieProjections_MovieProjectionId",
                        column: x => x.MovieProjectionId,
                        principalTable: "MovieProjections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SaleTransactions_Promotions_PromotionId",
                        column: x => x.PromotionId,
                        principalTable: "Promotions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SaleTransactions_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieComments_CinemaWorldUserId",
                table: "MovieComments",
                column: "CinemaWorldUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieProjections_CinemaId",
                table: "MovieProjections",
                column: "CinemaId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieProjections_HallId",
                table: "MovieProjections",
                column: "HallId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_News_CinemaWorldUserId",
                table: "News",
                column: "CinemaWorldUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsComments_CinemaWorldUserId",
                table: "NewsComments",
                column: "CinemaWorldUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReviewAuthors_AuthorId",
                table: "ReviewAuthors",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_CinemaWorldUserId",
                table: "SaleTransactions",
                column: "CinemaWorldUserId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_MovieProjectionId",
                table: "SaleTransactions",
                column: "MovieProjectionId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_PromotionId",
                table: "SaleTransactions",
                column: "PromotionId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleTransactions_TicketId",
                table: "SaleTransactions",
                column: "TicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StarRatings_AspNetUserId",
                table: "StarRatings",
                column: "AspNetUserId");
